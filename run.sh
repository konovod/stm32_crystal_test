...
openocd -f interface/stlink.cfg -f target/stm32f3x.cfg -c "adapter speed 4000; init; reset halt; flash write_image erase a.hex; flash verify_image a.hex; reset; exit"
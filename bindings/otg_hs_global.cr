...
module OTG_HS_GLOBAL
  ...
  struct OTG_HS_GAHBCFG
    ...
    # Burst length/type
    def hbstlen : UInt8
      UInt8.new!((@value >> 1) & 0xf_u32)
    end

    # Burst length/type
    def self.hbstlen : UInt8
      value.hbstlen
    end

    # Burst length/type
    def self.hbstlen=(value : UInt8) : UInt8
      self.set(hbstlen: value)
      value
    end
    ...
    def copy_with(
      *,
      ...
      unless hbstlen.nil?
        value = (value & 0xffffffe1_u32) |
                UInt32.new!(hbstlen.to_int).&(0xf_u32) << 1
      end

      unless dmaen.nil?
        value = (value & 0xffffffdf_u32) |
                UInt32.new!(dmaen.to_int).&(0x1_u32) << 5
      end
  ...
  struct OTG_HS_GUSBCFG
    ...
    # PHY Low-power clock select
    def self.phylpcs : Bool
      value.phylpcs
    end

    # PHY Low-power clock select
    def self.phylpcs=(value : Bool) : Bool
      self.set(phylpcs: value)
      value
    end
    ...
    # ULPI FS/LS select
    def self.ulpifsls : Bool
      value.ulpifsls
    end

    # ULPI FS/LS select
    def self.ulpifsls=(value : Bool) : Bool
      self.set(ulpifsls: value)
      value
    end
    ...
    # ULPI Auto-resume
    def self.ulpiar : Bool
      value.ulpiar
    end

    # ULPI Auto-resume
    def self.ulpiar=(value : Bool) : Bool
      self.set(ulpiar: value)
      value
    end
    ...
    # ULPI Clock SuspendM
    def self.ulpicsm : Bool
      value.ulpicsm
    end

    # ULPI Clock SuspendM
    def self.ulpicsm=(value : Bool) : Bool
      self.set(ulpicsm: value)
      value
    end
    ...
    # ULPI External VBUS Drive
    def self.ulpievbusd : Bool
      value.ulpievbusd
    end

    # ULPI External VBUS Drive
    def self.ulpievbusd=(value : Bool) : Bool
      self.set(ulpievbusd: value)
      value
    end
    ...
    # ULPI external VBUS              indicator
    def self.ulpievbusi : Bool
      value.ulpievbusi
    end

    # ULPI external VBUS              indicator
    def self.ulpievbusi=(value : Bool) : Bool
      self.set(ulpievbusi: value)
      value
    end
    ...
    # TermSel DLine pulsing              selection
    def self.tsdps=(value : Bool) : Bool
      self.set(tsdps: value)
      value
    end
    ...
    # ULPI interface protect              disable
    def self.ulpiipd : Bool
      value.ulpiipd
    end

    # ULPI interface protect              disable
    def self.ulpiipd=(value : Bool) : Bool
      self.set(ulpiipd: value)
      value
    end
      ...
      *,
      ...
      unless phylpcs.nil?
        value = (value & 0xffff7fff_u32) |
                UInt32.new!(phylpcs.to_int).&(0x1_u32) << 15
      end

      unless ulpifsls.nil?
        value = (value & 0xfffdffff_u32) |
                UInt32.new!(ulpifsls.to_int).&(0x1_u32) << 17
      end

      unless ulpiar.nil?
        value = (value & 0xfffbffff_u32) |
                UInt32.new!(ulpiar.to_int).&(0x1_u32) << 18
      end

      unless ulpicsm.nil?
        value = (value & 0xfff7ffff_u32) |
                UInt32.new!(ulpicsm.to_int).&(0x1_u32) << 19
      end

      unless ulpievbusd.nil?
        value = (value & 0xffefffff_u32) |
                UInt32.new!(ulpievbusd.to_int).&(0x1_u32) << 20
      end

      unless ulpievbusi.nil?
        value = (value & 0xffdfffff_u32) |
                UInt32.new!(ulpievbusi.to_int).&(0x1_u32) << 21
      end

      unless tsdps.nil?
        value = (value & 0xffbfffff_u32) |
                UInt32.new!(tsdps.to_int).&(0x1_u32) << 22
      end

      unless pcci.nil?
        value = (value & 0xff7fffff_u32) |
                UInt32.new!(pcci.to_int).&(0x1_u32) << 23
      end

      unless ptci.nil?
        value = (value & 0xfeffffff_u32) |
                UInt32.new!(ptci.to_int).&(0x1_u32) << 24
      end

      unless ulpiipd.nil?
        value = (value & 0xfdffffff_u32) |
                UInt32.new!(ulpiipd.to_int).&(0x1_u32) << 25
      end
    ...
    def self.set(
      *,
      ...
      self.value = self.value.copy_with(
        ...
        ulpiar: ulpiar,
        ulpicsm: ulpicsm,
        ulpievbusd: ulpievbusd,
        ulpievbusi: ulpievbusi,
        tsdps: tsdps,
        pcci: pcci,
        ptci: ptci,
        ulpiipd: ulpiipd,
  ...
  struct OTG_HS_GINTSTS
    ...
    def pxfr_incompisoout : Bool
      @value.bits_set?(0x200000_u32)
    end

    # Incomplete periodic              transfer
    def self.pxfr_incompisoout : Bool
      value.pxfr_incompisoout
    end

    # Incomplete periodic              transfer
    def self.pxfr_incompisoout=(value : Bool) : Bool
      self.set(pxfr_incompisoout: value)
      value
    end
    ...
    # Data fetch suspended
    def self.datafsusp : Bool
      value.datafsusp
    end

    # Data fetch suspended
    def self.datafsusp=(value : Bool) : Bool
      self.set(datafsusp: value)
      value
    end
    ...
    # Resume/remote wakeup detected              interrupt
    def self.wkuint : Bool
      value.wkuint
    end

    # Resume/remote wakeup detected              interrupt
    def self.wkuint=(value : Bool) : Bool
      self.set(wkuint: value)
      value
    end
    ...
    def copy_with(
      *,
      ...
      unless pxfr_incompisoout.nil?
        value = (value & 0xffdfffff_u32) |
                UInt32.new!(pxfr_incompisoout.to_int).&(0x1_u32) << 21
      end

      unless datafsusp.nil?
        value = (value & 0xffbfffff_u32) |
                UInt32.new!(datafsusp.to_int).&(0x1_u32) << 22
      end
      ...
      unless wkuint.nil?
        value = (value & 0x7fffffff_u32) |
                UInt32.new!(wkuint.to_int).&(0x1_u32) << 31
      end
    ...
    def self.set(
      *,
      ...
      self.value = self.value.copy_with(
        ...
        eopf: eopf,
        iisoixfr: iisoixfr,
        pxfr_incompisoout: pxfr_incompisoout,
        datafsusp: datafsusp,
        cidschg: cidschg,
        discint: discint,
        srqint: srqint,
  ...
  struct OTG_HS_GINTMSK
    ...
    def pxfrm_iisooxfrm : Bool
      @value.bits_set?(0x200000_u32)
    end

    # Incomplete periodic transfer              mask
    def self.pxfrm_iisooxfrm : Bool
      value.pxfrm_iisooxfrm
    end

    # Incomplete periodic transfer              mask
    def self.pxfrm_iisooxfrm=(value : Bool) : Bool
      self.set(pxfrm_iisooxfrm: value)
      value
    end
    ...
    # Data fetch suspended mask
    def self.fsuspm : Bool
      value.fsuspm
    end

    # Data fetch suspended mask
    def self.fsuspm=(value : Bool) : Bool
      self.set(fsuspm: value)
      value
    end
    ...
    def copy_with(
      *,
      ...
      unless pxfrm_iisooxfrm.nil?
        value = (value & 0xffdfffff_u32) |
                UInt32.new!(pxfrm_iisooxfrm.to_int).&(0x1_u32) << 21
      end

      unless fsuspm.nil?
        value = (value & 0xffbfffff_u32) |
                UInt32.new!(fsuspm.to_int).&(0x1_u32) << 22
      end
    ...
    def self.set(
      *,
      ...
      self.value = self.value.copy_with(
        ...
        oepint: oepint,
        iisoixfrm: iisoixfrm,
        pxfrm_iisooxfrm: pxfrm_iisooxfrm,
        fsuspm: fsuspm,
        hcim: hcim,
        ptxfem: ptxfem,
        cidschgm: cidschgm,
  ...
  struct OTG_HS_GCCFG
    ...
    # Enable I2C bus connection for the              external I2C PHY interface
    def self.i2_cpaden : Bool
      value.i2_cpaden
    end

    # Enable I2C bus connection for the              external I2C PHY interface
    def self.i2_cpaden=(value : Bool) : Bool
      self.set(i2_cpaden: value)
      value
    end
    ...
    # VBUS sensing disable              option
    def self.novbussens : Bool
      value.novbussens
    end

    # VBUS sensing disable              option
    def self.novbussens=(value : Bool) : Bool
      self.set(novbussens: value)
      value
    end
    ...
    def copy_with(
      *,
      ...
      unless i2_cpaden.nil?
        value = (value & 0xfffdffff_u32) |
                UInt32.new!(i2_cpaden.to_int).&(0x1_u32) << 17
      end
      ...
      unless novbussens.nil?
        value = (value & 0xffdfffff_u32) |
                UInt32.new!(novbussens.to_int).&(0x1_u32) << 21
      end
  ...
  struct OTG_HS_HPTXFSIZ
    ...
    # Host periodic TxFIFO depth
    def self.ptxfd : UInt16
      value.ptxfd
    end

    # Host periodic TxFIFO depth
    def self.ptxfd=(value : UInt16) : UInt16
      self.set(ptxfd: value)
      value
    end
    ...
    def copy_with(
      *,
      ...
      unless ptxfd.nil?
        value = (value & 0xffff_u32) |
                UInt32.new!(ptxfd.to_int).&(0xffff_u32) << 16
      end
